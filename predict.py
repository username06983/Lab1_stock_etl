...
def predict(db, schema, forecast_function_name,
    ...
    cur = return_snowflake_conn()
    # Build fully-qualified object names
...
with DAG(
  ...
  wait_for_etl_latest = ExternalTaskSensor(
      task_id="wait_for_etl_latest",
      external_dag_id="Stocks_data_ETL",
      external_task_id=None,
      execution_date_fn=latest_successful_etl_run,
  ...
  wait_for_etl_latest >> train_task >> predict_task